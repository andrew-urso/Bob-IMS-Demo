 ...
 * 
 * Prerequisites:
 *   - z/OSMF REST API accessible
 *   - IBMUSER.DFS.JCLLIB(CATIMP) job exists on z/OS
 *   - Connection properties in IMSConnectionConfig
 * 
 * Exit codes:
...
public class IMSCatalogImporter {
    ...
    private static final String ZOSMF_HOST = "172.19.3.3";
    private static final int ZOSMF_PORT = 443;
    private static final String ZOSMF_USER = System.getenv("ZOSMF_USER");
    private static final String ZOSMF_PASSWORD = System.getenv("ZOSMF_PASSWORD");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (ZOSMF_USER == null || ZOSMF_PASSWORD == null) {
                System.err.println("ERROR: z/OSMF credentials not set.");
                System.err.println("Set environment variables: ZOSMF_USER and ZOSMF_PASSWORD");
                System.exit(3);
            }
